...
- (void)insertNewObject:(id)sender
{
    ...
    [_objects insertObject:[[NSString alloc] initWithFormat:@"Bird Number: %d", _objects.count] atIndex:0];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.textLabel.text = [[NSString alloc] initWithFormat:@"%@", object.description];
    return cell;
}
